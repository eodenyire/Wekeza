    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                velocity_score = table.Column<int>(type: "integer", nullable: false),
                behavioral_score = table.Column<int>(type: "integer", nullable: false),
                relationship_score = table.Column<int>(type: "integer", nullable: false),
                amount_score = table.Column<int>(type: "integer", nullable: false),
                device_score = table.Column<int>(type: "integer", nullable: false),
                decision = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                risk_level = table.Column<string>(type: "character varying(20)", maxLength: 20, nullable: false),
                fraud_reasons = table.Column<string>(type: "character varying(500)", maxLength: 500, nullable: false),
