...
public record LoanScheduleItem
{
    ...
    public Money PrincipalAmount { get; init; } = null!;
    public Money InterestAmount { get; init; } = null!;
    public Money TotalAmount { get; init; } = null!;
    public Money OutstandingBalance { get; init; } = null!;
    public bool IsPaid { get; init; }
    public DateTime? PaidDate { get; init; }
    public Money PaidAmount { get; init; } = null!;

    // Parameterless constructor for EF Core
    private LoanScheduleItem() { }

    public LoanScheduleItem(int scheduleNumber, DateTime dueDate, Money principalAmount, Money interestAmount, Money totalAmount, Money outstandingBalance, bool isPaid, DateTime? paidDate, Money paidAmount)
    {
...
public record LoanCollateral
{
    ...
    public Money Value { get; init; } = null!;
    ...
    public LoanCollateral(Guid collateralId, string collateralType, string description, Money value, DateTime valuationDate, string? valuedBy)
    {
...
public record LoanGuarantor
{
    ...
    public Money GuaranteeAmount { get; init; } = null!;
    ...
    public LoanGuarantor(Guid guarantorId, string guarantorName, Money guaranteeAmount, DateTime guaranteeDate, string? guaranteeDocument)
    {
        GuarantorId = guarantorId;
        GuarantorName = guarantorName;
        GuaranteeAmount = guaranteeAmount;
        GuaranteeDate = guaranteeDate;
        GuaranteeDocument = guaranteeDocument;
    }
}
