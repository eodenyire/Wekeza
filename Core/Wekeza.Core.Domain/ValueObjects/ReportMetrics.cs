...
public class ReportMetrics : ValueObject
{
    ...
    public decimal CustomerDeposits { get; }
    public decimal LoanPortfolio { get; }
    ...
    public decimal NonInterestIncome { get; }
    public decimal OperatingExpenses { get; }
    public decimal ProvisionForLosses { get; }

    // Asset Quality Metrics
    public decimal NonPerformingLoans { get; }
    public decimal GrossNPLRatio { get; }
    public decimal NetNPLRatio { get; }
    public decimal LoanLossProvisions { get; }
    public decimal CoverageRatio { get; }
    public decimal ChargeOffAmount { get; }

    // Capital Adequacy Metrics
    public decimal Tier1Capital { get; }
    public decimal Tier2Capital { get; }
    public decimal TotalCapital { get; }
    public decimal RiskWeightedAssets { get; }
    public decimal CapitalAdequacyRatio { get; }
    public decimal Tier1CapitalRatio { get; }
    public decimal LeverageRatio { get; }

    // Liquidity Metrics
    public decimal LiquidAssets { get; }
    public decimal ShortTermLiabilities { get; }
    public decimal LiquidityRatio { get; }
    public decimal LiquidityCoverageRatio { get; }
    public decimal NetStableFundingRatio { get; }
    public decimal DepositToLoanRatio { get; }

    // Profitability Metrics
    public decimal ReturnOnAssets { get; }
    public decimal ReturnOnEquity { get; }
    public decimal NetInterestMargin { get; }
    public decimal CostToIncomeRatio { get; }
    public decimal OperatingMargin { get; }
    ...
    public decimal TransactionVolume { get; }
    public int NumberOfBranches { get; }
    public int NumberOfATMs { get; }
    public int NumberOfEmployees { get; }

    // Market Risk Metrics
    public decimal ValueAtRisk { get; }
    public decimal InterestRateRisk { get; }
    public decimal ForeignExchangeRisk { get; }
    public decimal TradingBookValue { get; }
    public decimal BankingBookValue { get; }
