...
public class AccountConfiguration : IEntityTypeConfiguration<Account>
{
    public void Configure(EntityTypeBuilder<Account> builder)
    {
        ...
        {
            nav.Property(p => p.Amount).HasColumnName("AccruedInterestAmount").HasPrecision(18, 2);
            nav.OwnsOne(p => p.Currency, c =>
            {
                c.Property(x => x.Code).HasColumnName("AccruedInterestCurrency").HasMaxLength(3);
            });
        });
        ...
        {
            nav.Property(p => p.Amount).HasColumnName("DailyTransactionLimitAmount").HasPrecision(18, 2);
            nav.OwnsOne(p => p.Currency, c =>
            {
                c.Property(x => x.Code).HasColumnName("DailyTransactionLimitCurrency").HasMaxLength(3);
            });
        });
        ...
        {
            nav.Property(p => p.Amount).HasColumnName("MonthlyTransactionLimitAmount").HasPrecision(18, 2);
            nav.OwnsOne(p => p.Currency, c =>
            {
                c.Property(x => x.Code).HasColumnName("MonthlyTransactionLimitCurrency").HasMaxLength(3);
            });
        });
        ...
        {
            nav.Property(p => p.Amount).HasColumnName("MinimumBalanceAmount").HasPrecision(18, 2);
            nav.OwnsOne(p => p.Currency, c =>
            {
                c.Property(x => x.Code).HasColumnName("MinimumBalanceCurrency").HasMaxLength(3);
            });
        });
