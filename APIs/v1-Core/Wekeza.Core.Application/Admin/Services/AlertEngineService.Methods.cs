...
public partial class AlertEngineService : IAlertEngineService
{
    ...
    public Task<AlertRuleDTO> CreateAlertRuleAsync(CreateAlertRuleDTO request, CancellationToken cancellationToken = default) 
        => Task.FromResult(new AlertRuleDTO());
    
    public Task<AlertRuleDTO> UpdateAlertRuleAsync(Guid ruleId, UpdateAlertRuleDTO request, CancellationToken cancellationToken = default) 
        => Task.FromResult(new AlertRuleDTO());
