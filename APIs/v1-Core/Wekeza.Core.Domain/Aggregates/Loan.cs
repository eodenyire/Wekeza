...
public record LoanScheduleItem
{
    ...
    public Money PrincipalAmount { get; init; }
...
public record LoanRestructureRequest
{
    ...
    public int? NewTermInMonths { get; init; }
    public int? PrincipalMoratorium { get; init; }
    public string Reason { get; init; }

    private LoanRestructureRequest()
    {
        Reason = string.Empty;
    }

    public LoanRestructureRequest(
        ...
        string reason)
    {
        ...
        PrincipalMoratorium = principalMoratorium;
        Reason = reason;
    }
}
