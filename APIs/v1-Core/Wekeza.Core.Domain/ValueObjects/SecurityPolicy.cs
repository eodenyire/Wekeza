...
public class SecurityPolicy : ValueObject
{
    ...
    public Dictionary<string, object> Rules { get; private set; } = new Dictionary<string, object>();
    public SecurityLevel Level { get; private set; }
    public bool IsEnforced { get; private set; }
    public DateTime EffectiveFrom { get; private set; }
    public DateTime? EffectiveTo { get; private set; }
    public string Description { get; private set; } = string.Empty;
    public List<string> ApplicableResources { get; private set; } = new List<string>();
